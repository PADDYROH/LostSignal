...
public class Driver {
	...
	public static void main(String[] args) {
		...
		tC.initialiseGame();
		// gE.getPlayerManager().addPlayer(new BasePlayer("100",
		// "password123".hashCode(), "joe dempsie", 0));
		// gE.getPlayerManager().addPlayer(new BasePlayer("101",
		// "321password".hashCode(), "homer simpson", 0));
...
//		gE.movePiece("r2", 5, 2);
		...
		/*
		 * mateos old main: GameEngineImpl ge = new GameEngineImpl();
		 * 
		 * // ge.getGameBoard()
		 * 
		 * GameBoardImpl gb = new GameBoardImpl();
		 * 
		 * for (int i = 0; i < gb.getChessBoard().length; i++) { for (int j = 0; j <
		 * gb.getChessBoard().length; j++) { if (gb.getChessBoard()[j][i] != null) {
		 * 
		 ...
		 * 
		 * gb.movePiece("r1w", 0, 3); gb.movePiece("r1w", 2, 3);
		 * 
		 * for (int i = 0; i < gb.getChessBoard().length; i++) { for (int j = 0; j <
		 * gb.getChessBoard().length; j++) { if (gb.getChessBoard()[j][i] != null) {
		 * 
